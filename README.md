...
> ℹ️ Currently the action has to be run on the default branch. Running it as part of a PR won't update the [Dependency graph](https://github.com/step-security/gradle-dependency-submission/network/dependencies) of your projects [Insights](https://github.com/step-security/gradle-dependency-submission/pulse) - This seems to be a GitHub requirement.
